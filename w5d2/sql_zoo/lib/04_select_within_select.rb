...
# find countries.population > 25000000 
# continents not in ^ above 

  # We want the continent where all countries.population < 25,000,000
  # we want all the countries in the continent
